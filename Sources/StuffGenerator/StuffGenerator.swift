...
public struct StuffGenerator {
    ...
    public static func generateInt(in range: ClosedRange<Int> = 1...100) -> Int {
    ...
    public static func generateInts(count: Int, in range: ClosedRange<Int> = 1...100) -> [Int] {
    ...
    public static func generateString(length: Int = 10, characters: String = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789") -> String {
    ...
    public static func generateStrings(count: Int, length: Int = 10, characters: String = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789") -> [String] {
